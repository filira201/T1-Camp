...
const ErrorBoundary = () => {
  ...
  return (
    <div className="flex flex-col gap-6 items-center justify-center min-h-screen p-6">
      <h1 className="text-3xl font-extrabold text-center text-red-600 sm:text-5xl">
        Что-то пошло не так
      </h1>
      ...
      <Card className="max-w-md w-full">
        <CardHeader className="px-6 pt-6 pb-2 flex flex-col items-center">
          {isRouteErrorResponse(error) ? (
            <>
              <h2 className="text-6xl font-extrabold text-center text-red-500 sm:text-8xl">
                {error.status}
              </h2>
        ...
        <CardBody className="px-6 py-4">
          <p className="text-center mb-6">
            Попробуйте обновить страницу или воспользуйтесь навигацией ниже.
          </p>
